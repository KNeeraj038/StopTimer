...
public class TimerManagerHandlerWay {
    private final String TAG = "NRJ_"+ TimerManagerHandlerWay.class.getSimpleName();
    private final Map<String, Timer> mTimers = new HashMap<>();
    private final TimerListener mListener;
    HandlerThread handlerThread;
    private Handler handler;
    public TimerManagerHandlerWay(TimerListener listener) {
        mListener = listener;
    }
